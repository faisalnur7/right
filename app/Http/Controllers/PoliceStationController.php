...
class PoliceStationController extends Controller
{
    public function index(Request $request){
        ...
        return view('admin.police_station.ps_index', compact('stations', 'divisions', 'districts', 'perPage'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.police_station.create', compact('districts'));
    }
    ...
    public function edit($id)
    {
        ...
        $districts = District::all();
        return view('admin.police_station.edit', compact('station', 'districts'));
    }
