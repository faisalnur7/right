...
class PostOfficeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.post_office.po_index', compact('postOffices', 'divisions', 'districts', 'stations', 'perPage'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.post_office.create', compact('policeStations'));
    }
    ...
    public function edit($id)
    {
        ...
        $policeStations = PoliceStation::all();
        return view('admin.post_office.edit', compact('postOffice', 'policeStations'));
    }
