...
@section('title', 'Used Product')
@section('page_title', 'Used Product')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header text-white rounded-top d-flex justify-content-between align-items-center"
                ...
                <h3 class="card-title mb-0">Used Product</h3>
            </div>
            ...
            <div class="card-body px-0 pb-3 pt-0">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped align-middle mb-0">
                        ...
                        <tbody>
                            @forelse($usedProducts as $usedProduct)
                                <tr>
                                    ...
                                    <td>{{ $usedProduct->used_at ? $usedProduct->used_at : 'N/A' }}</td>
