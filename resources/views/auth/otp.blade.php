                ...
                <form method="POST" action="{{ route('verify') }}">
                    ...
                    <div class="flex flex-col items-center justify-center mt-4 gap-2">
                        ...
                        <form method="POST" action="{{ route('resend.otp') }}">
                            ...
                            <button type="submit" class="text-blue-600 text-sm underline hover:text-blue-800">
                                Didn't receive OTP? Resend
                            </button>
                        </form>

                        <x-primary-button
                            class="w-full lg:w-1/2 flex mx-auto justify-center align-center py-3 mt-6 capitalize !text-lg !rounded-full">
                            {{ __('Go') }}
                        </x-primary-button>
                    </div>
                </form>
